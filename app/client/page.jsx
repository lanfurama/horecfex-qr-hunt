      ...
      <div className="mt-7 max-w-3xl bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-2xl shadow-lg text-left">
        ...
        <ol className="list-none space-y-3">
          <li className="flex items-start gap-2">
            <span>🏟</span> Đi dạo quanh sự kiện Horecfex 2025.
          </li>
          <li className="flex items-start gap-2">
            <span>📷</span> Quét QR tại các gian hàng để nhận điểm.
          </li>
          <li className="flex items-start gap-2">
            <span>🎯</span> QR đặc biệt có mini challenge, thắng sẽ được x2 điểm.
          </li>
          <li className="flex items-start gap-2">
            <span>🃏</span> Thu thập đủ thẻ sưu tập để nhận bonus points.
          </li>
          <li className="flex items-start gap-2">
            <span>⏰</span> Tham gia thử thách theo giờ để kiếm nhiều điểm hơn.
          </li>
          <li className="flex items-start gap-2">
            <span>🎁</span> Đổi điểm lấy quà tại khu vực Tech Zone.
          </li>
        </ol>
      </div>
    </div>
